...
namespace WinFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Game gameA = new Game { Id = 1, Name = "The Binding of Isaac", Studio = new Studio { Name = "Nicalis" }, Style = "Rogue-like", ReleaseDate = "28/09/2011", Gamemode = "одно-багатокористувацький", Sells = 2000000 };
            Game gameB = new Game { Id = 2, Name = "Minecraft", Studio = new Studio { Name = "Mojang" }, Style = "Sandbox", ReleaseDate = "18/09/2011", Gamemode = "одно-багатокористувацький", Sells = 300000000 };
